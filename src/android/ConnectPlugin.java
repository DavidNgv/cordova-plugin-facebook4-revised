...
public class ConnectPlugin extends CordovaPlugin {
    ...
    protected void pluginInitialize() {
        ...
        this.targetUrl = AppLinks.getTargetUrlFromInboundIntent(cordova.getActivity().getApplicationContext(), cordova.getActivity().getIntent());
    }
    ...
    public boolean execute(String action, JSONArray args, final CallbackContext callbackContext) throws JSONException {
        if (action.equals("login")) {
            ...
            return true;
        } else if (action.equals("getAppLinkUri")) {
            ...
            String res = "";
            if (targetUrl != null) {
                res = targetUrl.toString();
            }
            JSONObject json = new JSONObject();
            json.put("appLinkUri", res);
